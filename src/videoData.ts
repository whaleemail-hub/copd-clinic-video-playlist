...
export const videos: ClinicVideo[] = [
  ...
  },
  {
    ...
    src: "https://www.youtube.com/embed/RSAHSGxYY90",
    type: "youtube",
    durationSeconds: 2 * 60 + 5,
    durationNote: "實際片長 2:05；組合 D 使用",
  },
  {
    id: "seretide-mdi",
    category: "吸入劑",
    ...
    type: "embed",
    durationSeconds: 3 * 60 + 11,
    durationNote: "實際片長 3:11",
  },
  {
    id: "symbicort-mdi",
    category: "吸入劑",
    ...
    type: "embed",
    durationSeconds: 2 * 60 + 46,
    durationNote: "實際片長 2:46",
  },
  {
    ...
    type: "embed",
    durationSeconds: 3 * 60 + 11,
    durationNote: "實際片長 3:11；與使肺泰影片來源相同，請日後確認是否需替換",
  },
  {
    ...
    type: "embed",
    durationSeconds: 2 * 60 + 59,
    durationNote: "實際片長 2:59",
  },
  {
    id: "seretide-mouthpiece-spacer-short",
    category: "吸入劑",
    title: "使肺泰加口含式吸藥輔助器",
    src: "https://media.ntuh.gov.tw/media/e/868",
    type: "embed",
    durationSeconds: 1 * 60 + 56,
    durationNote: "實際片長 1:56；同主題第二段",
  },
  {
    id: "trimbow",
    category: "吸入劑",
  ...
  },
  {
    ...
    src: "https://www.youtube.com/embed/HKaFFVkprfM",
    type: "youtube",
    durationSeconds: 1 * 60 + 57,
    durationNote: "實際片長 1:57；組合 D 使用",
  },
  {
    id: "breztri",
    category: "吸入劑",
  ...
  },
  {
    ...
    type: "embed",
    durationSeconds: 3 * 60 + 58,
    durationNote: "實際片長 3:58",
  },
  {
    id: "nutrition-lung",
    category: "營養照護",
  ...
  },
  {
    ...
    type: "youtube",
    durationSeconds: 3 * 60 + 15,
    durationNote: "實際片長 3:15",
  },
  {
    id: "airway-clearance",
    category: "肺復原",
  ...
  },
  {
    ...
    durationNote: "實際片長 3:20",
  },
  {
    id: "resistance-band-second",
    category: "肺復原",
    title: "彈力帶運動",
    src: "https://www.youtube.com/embed/agSzsr7cQAc",
    type: "youtube",
    durationSeconds: 3 * 60 + 54,
    durationNote: "實際片長 3:54；同主題第二段",
  },
  {
    id: "chest-expansion",
    category: "肺復原",
...
export const programs: PlaylistProgram[] = [
  ...
  },
  {
    ...
    description: "急性惡化、使肺泰、吸必擴、吸藥輔助器清潔、營養與肺復原運動。",
    rounds: 4,
    videoIds: [
      "acute-exacerbation",
      "seretide-mdi",
